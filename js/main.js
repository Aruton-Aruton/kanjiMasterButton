"use strict";
{
  ...
  const yojijyukugoSet = [
    ...
    { k: "彫心鏤骨", m: "ちょうしんるこつ: 詩や文章などを書く際に非常に苦労して作り上げること" },
    { k: "桃李成蹊", m: "とうりせいけい: 徳を慕って自ずと人が集まること" },
    { k: "罵詈讒謗", m: "ばりぞうごん: 徳を慕って自ずと人が集まること" },
    { k: "尸位粗餐", m: "しいそさん: ある地位についているのに、その職務を果たさないこと" },
    ...
    { k: "茅堵蕭然", m: "ぼうとしょうぜん: かやぶきの垣根で粗末な家が物寂しいさま" },
    { k: "放蕩不覊", m: "ほうとうふき: 勝手気ままに振る舞うこと" },
    { k: "頑迷固陋", m: "がんめいころう: 頑固で視野が狭いこと" },
    { k: "苦心惨憺", m: "くしんさんたん: 苦労を重ね、工夫を凝らすこと" },
    { k: "洒洒落落", m: "しゃしゃらくらく: さっぱりしていて物事に執着しない性格、言動のこと" },
    {
      k: "斎戒沐浴",
      m: "さいかいもくよく: 神仏への祈りや、神聖な儀式の際に、飲食や行動を慎み、身を清めること",
    },
    { k: "聚蚊成雷", m: "しゅうかせいらい: 小さなものでも、たくさん集まれば大きな力になること" },
    { k: "痩身矮躯", m: "そうしんそうく: 痩せ細って体が小さいこと" },
    { k: "簇酒斂衣", m: "そうしゅれんい: 貧しい生活の例え" },
    { k: "断爛朝報", m: "だんらんちょうほう: 切れ切れになって続きがわからない朝廷の記録のこと" },
    { k: "笑面夜叉", m: "えんめんやしゃ: 笑っていても、心の底は陰険で裏表のある人" },
    ...
    { k: "塵飯塗羹", m: "じんぱんとこう: なんの役にも立たないもの、取るに足らないもの" },
    {
      k: "脣亡歯寒",
    ...
    { k: "灑掃応対", m: "さいそうおうたい: 日常生活において必要な仕事や作法のこと" },
    { k: "鑿壁偸光", m: "さくへきとうこう: 苦学することのたとえ" },
    { k: "于疎空闊", m: "うそくうかつ: 回りくどく実際に役に立たないこと" },
    { k: "禹行舜趨", m: "うこうしゅんすう: 見た目を真似しているだけで中身は伴っていないこと" },
    { k: "一饋十起", m: "いっきじっき: 熱心に賢者を集めるさま" },
    { k: "一丘一壑", m: "いっきゅういちがく: 俗世間を離れ、自然の中に身を置き、風流を楽しむこと" },
    ...
    { k: "対驢撫琴", m: "たいろぶきん: 愚かな人に道理を説いても、無駄であるということ" },
    { k: "断鶴続鳧", m: "だんかくぞくふ: 後先考えず自然に手を加え損なうこと" },
    { k: "袒裼裸裎", m: "たんせきらてい: 非常に無礼なさま" },
    { k: "磨礱砥礪", m: "まろうしれい: 気がつかないうちに、ものがすり減ってしまうたとえ" },
    { k: "霧鬢風鬟", m: "むびんふうかん: 美しい髪のこと" },
    { k: "銘肌鏤骨", m: "めいきるこつ: 心に深く刻み込んで忘れないこと" },
    { k: "和羹塩梅", m: "わこうあんばい: 主君を助けて、国を治める優秀な大臣、宰相のこと" },
  ];

  const kotowazaSet = [
    { k: "刎頚(ふんけい)の交わり", m: "生死をともにするほど、非常に親しいことのたとえ" },
    {
      k: "鷸蚌(いつぼう)の争い",
      m: "2人で利益を争っているうちに、別の第三者に取られてしまう事。漁夫の利と同じ",
    },
    { k: "斗筲(とそう)の人、何ぞ算(かぞ)うるに足らんや", m: "器量の狭い人のたとえ" },
    ...
    { k: "朝菌は晦朔(かいさく)を知らず", m: "短命であること、儚いことのたとえ" },
    { k: "滄海(そうかい)変じて桑田(そうでん)となる", m: "世の中の移り変わりが激しいこと" },
    {
    ...
    { k: "蕎麦(そば)の花見て蜜を取れ", m: "何事も時機を逃さず行えというたとえ" },
    {
      k: "荒馬の轡は前から",
    ...
    { k: "豆腐に鎹(かすがい)、糠(ぬか)に釘", m: "手応えがなく、全く効き目がないたとえ" },
    ...
    { k: "俯仰(ふぎょう)天地に愧じず", m: "自分の行動に何もやましいところがない" },
    {
    ...
    { k: "驪竜領下(りりょうがんか)の珠", m: "危険を冒さないと手に入らない貴重なもののたとえ" },
    { k: "苛政(かせい)は虎よりも猛し", m: "過酷な政治は、虎の害よりも甚大であること" },
    { k: "門前雀羅(もんぜんじゃくら)を張る", m: "訪ねてくる客もおらず、物寂しいさま" },
    { k: "独活(うど)の大木", m: "体が大きいだけでなんの役にも立たない人のたとえ" },
    {
      k: "暖簾(のれん)に腕押し",
    ...
    { k: "骨折り損の草臥れ(くたびれ)儲け", m: "疲れるだけで何も成果がないこと" },
  ];
  ...
  class Push {
    constructor(arraySet) {
      ...
      //配列の順番をシャッフルする
      this.randomKanjiSet = this.arraySet[Math.floor(Math.random() * this.length)];
